...
class Level1 extends React.Component{
    ...
    fetchLevelInfo(){
        return API_LEVEL.getPostLevelInfo(1,(result,status,error) =>{
    ...
    handleSubmitButton(){
        ...
        return API_LEVEL.postLevel1(this.state.searchField,(result,status,error) =>{
            if(result !== null ){
                console.log(result);
                if(status === 202){
                    this.setState({
        ...
        return(
            <div>
                ...
                <CardHeader style = {{fontSize: "20px"}}>
                    <strong> Level1:  {this.state.tableData.levelTitle}</strong>
                </CardHeader>
