...
class Level2 extends React.Component{
    ...
    fetchLevelInfo(){
        return API_LEVEL.getPostLevelInfo(2,(result,status,error) =>{
    ...
    handleSubmitButton(){
        ...
        return API_LEVEL.postLevel2(this.state.searchField,(result,status,error) =>{
            if(result !== null ){
                console.log(result);
                if(status === 202){
                    this.setState({
        ...
        return(
            <div>
                ...
                <CardHeader style = {{fontSize: "20px"}}>
                    <strong> Level2:  {this.state.tableData.levelTitle}</strong>
                </CardHeader>
