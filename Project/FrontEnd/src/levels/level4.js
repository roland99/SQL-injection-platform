...
class Level4 extends React.Component{
    ...
    fetchLevelInfo(){
        return API_LEVEL.getPostLevelInfo(4,(result,status,error) =>{
    ...
    handleSubmitButton(){
        ...
        return API_LEVEL.postLevel4(this.state.searchField,(result,status,error) =>{
            if(result !== null ){
                console.log(result);
                if(status === 202){
                    this.setState({
        ...
        return(
            <div>
                ...
                <CardHeader style = {{fontSize: "20px"}}>
                    <strong> Level4:  {this.state.tableData.levelTitle}</strong>
                </CardHeader>
