...
class Level6 extends React.Component{
    ...
    fetchLevelInfo(){
        return API_LEVEL.getPostLevelInfo(6,(result,status,error) =>{
    ...
    handleSubmitButton(){
        ...
        return API_LEVEL.postLevel6(body,(result,status,error) =>{
            if(result !== null ){
        ...
        return(
            <div>
                ...
                <CardHeader style = {{fontSize: "20px"}}>
                    <strong> Level6:  {this.state.tableData.levelTitle}</strong>
                </CardHeader>
